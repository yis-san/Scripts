...
function submit(){
    ...
    for(j=2; j<rowCount+1; j++) {
        ...
        if(rank == "captain" || rank == "lieutenant" || rank == "veteran") {
            total = 1.5*rtask1*3+1.5*1.5*rtask2*5+1.5*rtask3*5+1.5*su5*5+1.5*add*3+1.5*v1*5+1.5*rtask4*13+1.5*rtask5*5+1.5*best*5+1.5*rtask5n*3+1.5*rtask6*4+1.5*rtask7*7+1.5*rtask8*15+1.5*ntask1*12+1.5*ntask2*10+1.5*ntask3*8+1.5*ntask4*4;
            ...
            total = rtask1*3+1.5*rtask2*5+rtask3*5+su5*5+add*3+v1*5+rtask4*13+rtask5*5+best*5+rtask5n*3+rtask6*4+rtask7*7+rtask8*15+ntask1*12+ntask2*10+ntask3*8+ntask4*4;
